# 附录 B03：角色卡开放交换格式规范（CSON）（原附录 K）

> **文档版本**：V1.6 | **状态**：正式发布 | **设计参考**：HKTRPG Bot、Session Zero Format (.szf)、rpgsheet | **Schema 版本**：1.0
...
- 本次统一到 V1.6 的是**文档版本**，不是 CSON 的 `schema_version`；交换格式仍保持 `1.0`。
