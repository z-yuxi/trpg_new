附录B 设计令牌（Design Tokens）
> **版本**：v1.5（品牌色恢复 + 语义命名统一）  
> **更新日期**：2026-04-25  
> **核心变更**：
...
**文档版本：** v2.0（品牌色恢复版）  
**维护者：** 设计团队  
**下次评审：** 2026-05-25（废弃变量移除日）
"""

with open('/mnt/agents/output/附录B_设计令牌_v2.0.md', 'w', encoding='utf-8') as f:
    f.write(content)

print(f"附录B已生成，大小: {len(content)} 字符")
